  ...
  return (
    <div className="flex-1 overflow-y-auto p-10 bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <QuickCard icon="➕" text="New Requirement" color="text-emerald-600" />
        <QuickCard icon="🔥" text="Fresh Promotions" color="text-orange-600" />
        <QuickCard icon="🔄" text="Route Matches" color="text-purple-600" />
        <QuickCard icon="🎟️" text="My Tickets" color="text-red-600" />
        <QuickCard icon="📝" text="Personal Tracker" color="text-blue-600" />
        <QuickCard icon="📡" text="Live Routes" color="text-teal-600" />
